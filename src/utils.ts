...
/**
  ...
  */
 export const useForkRef = <T>(refA: RefValue<T>, refB: RefValue<T>) => {
  return useMemo(() => {
...
export const makeUnprivilegedEditor = (editor: Editor): UnprivilegedEditor => {
  if (!editor) return;
  return {
    focus: function () { return editor.focus.apply(editor, arguments as unknown as []); },
    blur: function () { return editor.focus.apply(editor, arguments as unknown as []); },
    ...
    getFormat: function () { return editor.getFormat.apply(editor, arguments as unknown as []); },
    getIndex: function () { return editor.getIndex.apply(editor, arguments as any); },
    getLeaf: function () { return editor.getLeaf.apply(editor, arguments  as any); }
  };
}

// True if the value is a Delta instance or a Delta look-alike.
export const isDelta = (value: any): boolean => {
